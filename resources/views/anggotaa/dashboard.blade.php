...
<head>
    ...
    <title>@yield('title', 'Anggota Dashboard')</title>
    <style>
        body {
...
<body>
    ...
    <nav>
        <div class="card" onclick="window.location.href='/surats'">
            <img src="/images/SURAT_IMAGE.png" alt="Surat">
        ...
        <div class="card" onclick="window.location.href='/anggota'">
            <img src="/images/ANGGOTA_IMAGE.png" alt="Anggota">
            <div class="card-content">
                <h3>Lihat Anggota</h3>
            </div>
        </div>
        ...
        <div class="card" onclick="window.location.href='/kas'">
            <img src="/images/KAS_IMAGE.png" alt="Kas">
            <div class="card-content">
                <h3>Lihat Kas</h3>
            </div>
        </div>
